    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 w-1/3">
      <div class="relative p-4 w-full h-full md:h-auto">
        ...
        <div class="py-6 px-6 lg:px-8 text-center">
          ...
          <p class="text-xl text-gray-100">Are you sure you want to delete this stream? Deletions are irreversible.</p>
...
// PROPS
const props = defineProps(['id', 'streamname']);

//MISC
import { ref } from 'vue';

let isOpen = ref(false);
let name = ref(props.streamname);
...
async function onDelete() {
	await organizationStore.deleteStream(props.id);
