    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 w-1/3">
      <div class="relative p-4 w-full h-full md:h-auto">
        ...
        <div class="py-6 px-6 lg:px-8 text-left">
          <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white text-center">Edit Organization</h3>
...
const orgname = ref(props.org.name);
const email = ref(props.org.email);
const accesstoken = ref(props.org.mux_accessToken);
const secret = ref(props.org.mux_secret);
